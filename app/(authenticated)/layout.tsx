        ...
        >
          ...
          <List subheader={<ListSubheader>提供スケジュール</ListSubheader>}>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/schedule" onClick={linkHandler}>
                <ListItemText primary={'スケジュール一覧'} />
              </ListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/scheduleRegistration" onClick={linkHandler}>
          ...
          <List subheader={<ListSubheader>店舗情報</ListSubheader>}>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/shop" onClick={linkHandler}>
                <ListItemText primary={'店舗一覧'} />
              </ListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/shopDetail" onClick={linkHandler}>
          ...
          <List subheader={<ListSubheader>会社情報</ListSubheader>}>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/company" onClick={linkHandler}>
                <ListItemText primary={'会社一覧'} />
              </ListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/companyDetail" onClick={linkHandler}>
          ...
          <List subheader={<ListSubheader>ユーザー情報</ListSubheader>}>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/user" onClick={linkHandler}>
          ...
          <List subheader={<ListSubheader>オーダー情報</ListSubheader>}>
            <ListItem disablePadding>
              <ListItemButton component="button" data-url="/order" onClick={linkHandler}>
